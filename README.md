...
- Designed & implemented scalable backend components for **post-trade clearing systems** in equity and forex markets using **Java** and **C++**  
- Developed & automated end-to-end test suites in Linux & Windows environments (**JUnit**, **gtest**)  
...
- Developed and maintained core services for **LCH Equity Clear, Forex Clear, and Repo Clear**  
...
- Built a full-stack web application using **React** + **Ballerina** with focus on backend communication and frontend UX
